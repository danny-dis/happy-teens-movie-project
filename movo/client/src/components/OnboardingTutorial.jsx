...
const OnboardingTutorial = ({ onComplete }) => {
  const { isStreamingMode, toggleMode } = useChimera();
  ...
  const steps = [
    {
      ...
      description: 'Your hybrid streaming and local content platform. Let\'s take a quick tour to get you started.',
      target: null,
      position: 'center'
    },
    {
      title: 'Chimera Mode',
      description: 'Switch between streaming and local content with our unique Chimera Mode toggle. Try it now!',
      target: '.chimera-toggle-container',
      position: 'bottom',
      action: {
        label: 'Try Switching',
        handler: toggleMode
    ...
    },
    {
      ...
      description: 'Quickly find movies, actors, or genres with our powerful search. Press "/" to focus the search bar anytime.',
      target: '.global-search',
      position: 'bottom'
    },
    {
      title: 'Browse Categories',
      description: 'Explore content by categories. Find what you love or discover something new.',
      target: '.categories-section',
      position: 'right'
    },
    {
      title: 'Your Library',
      description: 'Access your downloaded content here. Available even when you\'re offline.',
      target: '.library-section',
      position: 'left'
    },
    {
      title: 'You\'re All Set!',
      description: 'Enjoy your Movo experience. You can revisit this tutorial anytime from the settings menu.',
      target: null,
      position: 'center'
    }
  ];
  ...
  const handleComplete = () => {
    ...
    localStorage.setItem('movo_onboarding_completed', 'true');
  ...
  const handleSkip = () => {
    ...
    // Track tutorial skip for analytics
    analyticsService.trackEvent(
      EVENT_CATEGORIES.USER,
      'onboarding_skip',
      {
